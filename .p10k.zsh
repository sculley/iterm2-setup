# Generated by Powerlevel10k configuration wizard on 2022-12-24 at 07:13 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=213
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=231
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=231
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=026
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=244
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=056
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=016
  typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=172
  ...
  typeset -g POWERLEVEL9K_AZURE_BACKGROUND=238
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND=196
